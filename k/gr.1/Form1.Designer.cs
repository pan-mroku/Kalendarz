...
namespace gr._1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.picturebox_wpisy_dnia = new System.Windows.Forms.PictureBox();
        	...
        	((System.ComponentModel.ISupportInitialize)(this.picturebox_wpisy_dnia)).BeginInit();
        	...
        	this.toolTip1.SetToolTip(this.usun_wpis, "Usuwa wpis o podanym tytule, zaczynający się o wpisanej porze.");
        	this.usun_wpis.UseVisualStyleBackColor = false;
        	this.usun_wpis.Click += new System.EventHandler(this.Usun_wpisClick);
        	// 
        	// panel3
        	// 
        	this.panel3.BackColor = System.Drawing.SystemColors.InactiveCaptionText;
        	this.panel3.Controls.Add(this.picturebox_wpisy_dnia);
        	...
        	((System.ComponentModel.ISupportInitialize)(this.picturebox_wpisy_dnia)).EndInit();
